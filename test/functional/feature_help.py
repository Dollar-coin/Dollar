...
"""Verify that starting dollar with -h works as expected."""

from test_framework.test_framework import DollarTestFramework
from test_framework.util import assert_equal

class HelpTest(DollarTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dollar with -h for help text")
        ...
        self.log.info("Start dollar with -version for version information")
        ...
        self.log.info("Start dollard with -fakearg to make sure it does not start")
