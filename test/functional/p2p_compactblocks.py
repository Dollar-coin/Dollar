...
# TestP2PConn: A peer we use to send messages to dollard, and store responses.
...
class CompactBlocksTest(DollarTestFramework):
    ...
    # This test actually causes dollard to (reasonably!) disconnect us, so do this last.
    ...
    # Test that dollard requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dollard to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # dollard will not send blocktxn responses for blocks whose height is
