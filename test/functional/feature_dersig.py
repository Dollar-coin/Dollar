...
class BIP66Test(DollarTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # dollard is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and dollard produces more specific reject
            # reasons.
