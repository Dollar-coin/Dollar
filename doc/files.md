...
* dollar.conf: contains configuration settings for dollard or dollar-qt
* dollard.pid: stores the process id of dollard while running
...
* debug.log: contains debug information and general logging generated by dollard or dollar-qt
