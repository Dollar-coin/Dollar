...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " dollar-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  dollar-tx [options] <hex-tx> [commands]  Update hex-encoded dollar transaction\n" +
            "or:     dollar-tx [options] -create [commands]   Create hex-encoded dollar transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dollar transaction
