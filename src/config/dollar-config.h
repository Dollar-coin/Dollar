/* src/config/dollar-config.h.  Generated from dollar-config.h.in by configure.  */
/* src/config/dollar-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DOLLAR_CONFIG_H

#define DOLLAR_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Dollar Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Dollar Core"
...
#define PACKAGE_BUGREPORT "https://github.com/dollar-coin/dollar-coin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dollar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dollar Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dollar"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://dollarcore.org/"
