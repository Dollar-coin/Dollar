...
#ifndef DOLLAR_TEST_SCRIPTNUM10_H
#define DOLLAR_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Dollar Core 0.10.0, for cross-comparison.
 */
public:
