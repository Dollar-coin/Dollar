...
{
    BOOST_CHECK(TestSplitHost("www.dollarcore.org", "www.dollarcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.dollarcore.org]", "www.dollarcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.dollarcore.org:80", "www.dollarcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.dollarcore.org]:80", "www.dollarcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:17704", "127.0.0.1", 17704));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:17704", "127.0.0.1", 17704));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:17704", "::ffff:127.0.0.1", 17704));
    BOOST_CHECK(TestSplitHost("[::]:17704", "::", 17704));
    BOOST_CHECK(TestSplitHost("::17704", "::17704", -1));
    BOOST_CHECK(TestSplitHost(":17704", "", 17704));
    BOOST_CHECK(TestSplitHost("[]:17704", "", 17704));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:17704", "127.0.0.1:17704"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:17704", "[::]:17704"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
