...
#ifndef DOLLAR_WALLET_WALLET_H
#define DOLLAR_WALLET_WALLET_H
...
static const unsigned int DEFAULT_TX_CONFIRM_TARGET = 50;
//! -walletrbf default
...
public:
     ...
     * on this dollar node, and set to 0 for transactions that were created
