...
#ifndef DOLLAR_QT_DOLLARUNITS_H
#define DOLLAR_QT_DOLLARUNITS_H
...
/** Dollar unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DollarUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DollarUnits(QObject *parent);

    /** Dollar units.
      @note Source: https://en.dollar.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DOLLAR,
...
typedef DollarUnits::Unit DollarUnit;

#endif // DOLLAR_QT_DOLLARUNITS_H
