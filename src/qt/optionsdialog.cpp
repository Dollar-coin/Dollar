    ...
    mapper(0)
{
    ...
    ui->dollarAtStartup->setToolTip(ui->dollarAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->dollarAtStartup->setText(ui->dollarAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDollarConfButton->setToolTip(ui->openDollarConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new DollarUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->dollarAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDollarConfButton_clicked()
{
