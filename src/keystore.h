...
#ifndef DOLLAR_KEYSTORE_H
#define DOLLAR_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/dollar/bips/blob/master/bip-0013.mediawiki
