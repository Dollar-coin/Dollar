 ...
 */
#ifndef DOLLAR_UTIL_H
#define DOLLAR_UTIL_H
...
extern const char * const DOLLAR_CONF_FILENAME;
extern const char * const DOLLAR_PID_FILENAME;
...
{
    std::string s = strprintf("dollar-%s", name);
